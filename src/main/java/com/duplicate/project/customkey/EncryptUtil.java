...
public class EncryptUtil {
	    ...
	    public static void main(String args[]) throws IOException {
	        ...
	        String plainText = "Action,Adminstration,Session,Settings";
	        System.out.println("PLAIN = " + plainText);
	        System.out.println("ENCRYPTED = " + EncryptUtil.encrypt(plainText));
	       String d= EncryptUtil.encrypt(plainText);
	       System.out.println("DCRYPTED = " + EncryptUtil.decrypt(d));
	    }
	}
